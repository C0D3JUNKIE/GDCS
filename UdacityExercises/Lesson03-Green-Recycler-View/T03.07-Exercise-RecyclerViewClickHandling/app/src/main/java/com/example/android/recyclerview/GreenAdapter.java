...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // COMPLETE (3) Create a final private ListItemClickListener called mOnClickListener
    ...
    // COMPLETE (1) Add an interface called ListItemClickListener
    // COMPLETE (2) Within that interface, define a void method called onListItemClick that takes an int as a parameter
    public interface ListItemClickListener{
        void onListItemClick(int clickedItemIndex);
    }

    // COMPLETE (4) Add a ListItemClickListener as a parameter to the constructor and store it in mOnClickListener
    /**
    ...
    // COMPLETE (5) Implement OnClickListener in the NumberViewHolder class
    /**
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements OnClickListener{
        ...
        // COMPLETE (6) Override onClick, passing the clicked item's position (getAdapterPosition()) to mOnClickListener via its onListItemClick method
    }
}
