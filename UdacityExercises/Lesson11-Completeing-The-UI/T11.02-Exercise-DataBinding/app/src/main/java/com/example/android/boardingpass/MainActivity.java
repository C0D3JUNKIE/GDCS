...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalMinutesUnitlBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalMinutesUnitlBoarding);
        long minutesLessHoursUntilBoarding = totalMinutesUnitlBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
