...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL_EXTRA = "queryHolder";
    // COMPLETE (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RAW_JSON = "resultsHolder";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETE (9) If the savedInstanceState bundle is not null, set the text of the URL and search results TextView respectively
         if(savedInstanceState != null){
             String queryUrl = savedInstanceState.getString(QUERY_URL_EXTRA);
             String rawJsonSearchResults = savedInstanceState.getString(SEARCH_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_URL_EXTRA, queryUrl);
        String rawJsonSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RAW_JSON, rawJsonSearchResults);
    }
}