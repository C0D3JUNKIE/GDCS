...
public class NotificationUtils {
    ...
    private static Action ignoreReminderAction(Context context){
        ...
        Action ignoreReminderAction = new Action(R.drawable.ic_cancel_black_24px, "No, Thank you.", ignoreReminderPendingIntent);
    ...
    private static Action drinkWaterAction(Context context){
        ...
        Action drinkWaterAction = new Action(R.drawable.ic_local_drink_black_24px, "I done did it!", incrementWaterPendingIntent);
