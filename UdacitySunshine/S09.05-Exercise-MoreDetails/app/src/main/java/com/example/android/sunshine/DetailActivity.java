...
//  COMPLETE (20) Create a constant int to identify our loader used in DetailActivity
    public static final String[] WEATHER_DETAIL_PROJECTION = {WeatherEntry.COLUMN_DATE, WeatherEntry.COLUMN_MAX_TEMP,
        WeatherEntry.COLUMN_MIN_TEMP, WeatherEntry.COLUMN_HUMIDITY, WeatherEntry.COLUMN_PRESSURE, WeatherEntry.COLUMN_WIND_SPEED,
...
//  COMPLETE (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mHighTempertureView;
...
//      COMPLETE (13) Find each of the TextViews by ID
        ...
        mDescriptionView = (TextView) findViewById(R.id.high_temperature);
        mHighTempertureView = (TextView) findViewById(R.id.high_temperature);
...
//      COMPLETE (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        long localDataMidnightGmt = data.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this, localDataMidnightGmt, true);
        ...
        mHighTempertureView.setText(highString);
        ...
        String presureString = getString(R.string.format_pressure, pressure);
        mPressureView.setText(presureString);
